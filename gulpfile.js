...
mapapps.registerTasks({
						  ...
						  hasBaseThemes:      true, /* state that we want to support vuetify components and therefore need the the vuetify core styles*/
						  hasVuetify:         true,
						  themeChangeTargets: {
							  "vuetify": [
								  //"theme-custom"
...
gulp.task("default", gulp.series("copy-resources",
								 "themes-copy",
